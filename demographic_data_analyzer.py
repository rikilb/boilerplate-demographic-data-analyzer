...
def calculate_demographic_data(print_data=True):
    ...
    lower_education = df[~df["education"].isin(["Bachelors","Masters","Doctorate"])] # ~ se usa para negar
    ...
    serie_paises = df[df["salary"] == ">50K"]["native-country"].value_counts() * 100 / df["native-country"].value_counts()
    highest_earning_country = serie_paises.idxmax()
    highest_earning_country_percentage = round(serie_paises.max(),1)
